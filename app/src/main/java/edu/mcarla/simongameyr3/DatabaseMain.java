...
public class DatabaseMain extends AppCompatActivity {
    ...
    EditText DateInput, NameInput, ScoreInput, IDInput;
    Button btnAddData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddData = findViewById(R.id.AddDataBTN);
    ...
    //Adding data from text view
    public void AddData() {
        btnAddData.setOnClickListener(
                new View.OnClickListener(){
                    @Override
                    public void onClick(View v){
                        mydb.insertData(DateInput.getText().toString(),
                     ...
                     /* if(isInserted == true)
                        ...
                        String log =
                                "Id: " + hs.getScore_id() +
                                        ...
                                        " , Player: " + NameInput.getText().toString() +
